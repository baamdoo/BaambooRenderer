...
private:
    ...
    Arc< render::Texture > LoadTextureArray(const fs::path& dirpath, bool bGenerateMips = false, render::eTextureColorSpace colorSpace = render::eTextureColorSpace::Linear);
