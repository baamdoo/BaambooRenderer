...
CommandSignature::CommandSignature(Dx12RenderDevice& rd, CommandSignatureDesc& signatureDesc, ID3D12RootSignature* d3d12RootSignature)
{
	auto d3d12Device = rd.GetD3D12Device();
